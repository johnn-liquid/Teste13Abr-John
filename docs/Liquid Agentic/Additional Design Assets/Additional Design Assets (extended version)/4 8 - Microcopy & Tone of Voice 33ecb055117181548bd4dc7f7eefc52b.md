...
Sources: CEO Braindump (regulated market, compliance), 4.4 Experience Context (archetypes), 5.1 Ubiquitous Language, LuriDS AI-INSTRUCTIONS
...
- 4.4 Experience Context — archetype definitions that inform the vocabulary bridge
- 5.1 Ubiquitous Language — canonical entity names and prohibited terms
- 4.2 Design System: Architectural Decisions — motion decisions that affect copy timing
