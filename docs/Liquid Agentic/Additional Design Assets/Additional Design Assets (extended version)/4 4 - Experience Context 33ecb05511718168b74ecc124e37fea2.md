...
- 4.5 UX Functional Architecture — where archetypes and intents manifest in the screen map
- 4.6 Interaction Model — governance moments in technical terms
- 4.8 Microcopy & Tone of Voice — how the system speaks to each archetype
